(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		{
			// deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><span class="glyphicon glyphicon-remove"></span></a>'; //close button use glyphon remove icon, (uncomment this and the ctylesheet cdn in html file)
			deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><span aria-hidden="true">&times;</span</a>'; //close button use bootstap icon (comment this if use the top remove icon)
		}
